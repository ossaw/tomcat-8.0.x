...
public class TestOpenSSLCipherConfigurationParser {
    ...
    public void testDEFAULT() throws Exception {
        if (TesterOpenSSL.VERSION < 10100) {
            ...
            testSpecification(
                    "DEFAULT:!RC4:!DSS:!SEED:!IDEA:!CAMELLIA:!AESCCM:!3DES");
        } else {
    ...
    public void testCOMPLEMENTOFDEFAULT() throws Exception {
        if (TesterOpenSSL.VERSION < 10100) {
            // Account for classes of ciphers removed from DEFAULT in 1.1.0
            testSpecification(
                    "COMPLEMENTOFDEFAULT:RC4:DSS:SEED:IDEA:CAMELLIA:AESCCM:aNULL:3DES");
        } else {
    ...
    public void testSpecification02() throws Exception {
        ...
        testSpecification(
                "!aNULL:!eNULL:!EXPORT:!DSS:!DES:!SSLv2:kEECDH:ECDH:EDH:AES256-GCM-SHA384:AES128-GCM-SHA256:+RC4:HIGH:aRSA:kECDHr:MEDIUM");
    }
    ...
    public void testSpecification03() throws Exception {
        ...
        testSpecification(
                "EECDH+aRSA+SHA384:EECDH:EDH+aRSA:RC4:!aNULL:!eNULL:!LOW:!3DES:!MD5:!EXP:!PSK:!SRP:!DSS");
    }
    ...
    private void testSpecification(String specification) throws Exception {
        ...
        String openSSLCipherList = TesterOpenSSL.getOpenSSLCiphersAsExpression(
                specification);
        List<String> jsseCipherListFromOpenSSL = OpenSSLCipherConfigurationParser
                .parseExpression(openSSLCipherList);
        List<String> jsseCipherListFromParser = OpenSSLCipherConfigurationParser
                .parseExpression(specification);
        ...
        Assert.assertTrue(jsseCipherListFromOpenSSL.containsAll(
        ...
        String parserOrderedExpression = listToString(jsseCipherListFromParser,
                ',');
        Assert.assertEquals(listToString(OpenSSLCipherConfigurationParser
                .parseExpression(parserOrderedExpression), ','),
