...
public class TestCipher {
    ...
    public void testAllOpenSSLCiphersMapped() throws Exception {
        Set<String> openSSLCipherSuites = TesterOpenSSL.getOpenSSLCiphersAsSet(
                "ALL:eNULL");

        StringBuilder errors = new StringBuilder();

        for (String openSSLCipherSuite : openSSLCipherSuites) {
            List<String> jsseCipherSuites = OpenSSLCipherConfigurationParser
                    .parseExpression(openSSLCipherSuite);
            ...
            for (JsseImpl jsseImpl : JSSE_IMPLS) {
                ...
                for (String jsseCipherSuite : jsseCipherSuites) {
                    if (jsseImpl.getStandardNames().contains(jsseCipherSuite)) {
                        found = true;
                        if (jsseImpl.getOpenSslUnmapped().contains(
                                openSSLCipherSuite)) {
                            errors.append("Mapping found in " + jsseImpl
                                    .getVendor() + "'s JSSE implementation for "
                                    + openSSLCipherSuite
                ...
                if (!found && !jsseImpl.getOpenSslUnmapped().contains(
                        openSSLCipherSuite)) {
    ...
    public void testOpenSSLCipherAvailability() throws Exception {
        ...
        Set<String> availableCipherSuites = TesterOpenSSL
                .getOpenSSLCiphersAsSet("ALL:eNULL:aRSA");
        Set<String> expectedCipherSuites = new HashSet<>();
        for (Cipher cipher : Cipher.values()) {
            if (TesterOpenSSL.OPENSSL_UNIMPLEMENTED_CIPHERS.contains(cipher)) {
                continue;
            }
            expectedCipherSuites.add(cipher.getOpenSSLAlias() + "+" + cipher
                    .getProtocol().getOpenSSLName());
        }
        ...
        Assert.assertEquals(unexpectedList.toString(), 0, unexpectedCipherSuites
                .size());
    }
    ...
    public void testNames() {
        for (Cipher cipher : Cipher.values()) {
            ...
            if (name.contains("EXPORT1024") || name.equals(
            ...
            Assert.assertTrue("Non-registered name used in Cipher enumeration: "
                    + cipher, REGISTERED_NAMES.contains(name));
        }
    }
     ...
     * on 15th July 2014.
     */
    private static final Set<String> CIPHER_SUITE_STANDARD_NAMES_ORACLE = Collections
            .unmodifiableSet(new HashSet<>(Arrays.asList(
                    ...
                    "TLS_KRB5_WITH_IDEA_CBC_MD5", "TLS_KRB5_WITH_IDEA_CBC_SHA",
                    ...
                    "TLS_PSK_WITH_AES_256_GCM_SHA384", "TLS_PSK_WITH_NULL_SHA",
                    ...
                    "TLS_RSA_PSK_WITH_NULL_SHA", "TLS_RSA_PSK_WITH_NULL_SHA256",
                    ...
                    "SSL_RSA_WITH_DES_CBC_SHA", "SSL_RSA_WITH_IDEA_CBC_SHA",
                    "SSL_RSA_WITH_NULL_MD5", "SSL_RSA_WITH_NULL_SHA",
                    "TLS_RSA_WITH_NULL_SHA256", "SSL_RSA_WITH_RC4_128_MD5",
                    "SSL_RSA_WITH_RC4_128_SHA", "TLS_RSA_WITH_SEED_CBC_SHA",
     ...
     */
    private static Set<String> OPENSSL_UNMAPPED_ORACLE = Collections
            .unmodifiableSet(new HashSet<>(Arrays.asList("AES128-CCM+TLSv1.2",
                    "AES128-CCM8+TLSv1.2", "AES256-CCM+TLSv1.2",
                    "AES256-CCM8+TLSv1.2", "DES-CBC-MD5+SSLv2",
                    "DES-CBC3-MD5+SSLv2", "DHE-PSK-AES128-CCM+TLSv1.2",
                    "DHE-PSK-AES128-CCM8+TLSv1.2", "DHE-PSK-AES256-CCM+TLSv1.2",
                    ...
                    "DHE-RSA-AES128-CCM+TLSv1.2", "DHE-RSA-AES128-CCM8+TLSv1.2",
                    "DHE-RSA-AES256-CCM+TLSv1.2", "DHE-RSA-AES256-CCM8+TLSv1.2",
                    ...
                    "EXP-RC2-CBC-MD5+SSLv2", "EXP-RC4-MD5+SSLv2",
                    "IDEA-CBC-MD5+SSLv2", "PSK-AES128-CCM+TLSv1.2",
                    "PSK-AES128-CCM8+TLSv1.2", "PSK-AES256-CCM+TLSv1.2",
                    "PSK-AES256-CCM8+TLSv1.2", "PSK-CAMELLIA128-SHA256+TLSv1",
                    "PSK-CAMELLIA256-SHA384+TLSv1",
                    "PSK-CHACHA20-POLY1305+TLSv1.2", "RC2-CBC-MD5+SSLv2",
                    "RC4-MD5+SSLv2", "RSA-PSK-CAMELLIA128-SHA256+TLSv1",
    ...
    static {
        Set<String> sslNames = new HashSet<>(Arrays.asList(
                ...
                "SSL_ECDHE_RSA_WITH_RC4_128_SHA", "SSL_RSA_WITH_RC4_128_SHA",
                ...
                "SSL_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA",
                "SSL_DH_anon_EXPORT_WITH_DES40_CBC_SHA",
                "SSL_KRB5_WITH_RC4_128_SHA", "SSL_KRB5_WITH_RC4_128_MD5",
                "SSL_KRB5_WITH_3DES_EDE_CBC_SHA",
                "SSL_KRB5_WITH_3DES_EDE_CBC_MD5", "SSL_KRB5_WITH_DES_CBC_SHA",
                "SSL_KRB5_WITH_DES_CBC_MD5", "SSL_KRB5_EXPORT_WITH_RC4_40_SHA",
     ...
     */
    private static Set<String> OPENSSL_UNMAPPED_IBM = Collections
            .unmodifiableSet(new HashSet<>(Arrays.asList(
                    "ADH-CAMELLIA128-SHA+SSLv3", "ADH-CAMELLIA256-SHA+SSLv3",
                    "ADH-CAMELLIA128-SHA256+TLSv1.2",
                    "ADH-CAMELLIA256-SHA256+TLSv1.2", "ADH-SEED-SHA+SSLv3",
                    "AES128-CCM+TLSv1.2", "AES128-CCM8+TLSv1.2",
                    "AES256-CCM+TLSv1.2", "AES256-CCM8+TLSv1.2",
                    "CAMELLIA128-SHA+SSLv3", "CAMELLIA256-SHA+SSLv3",
                    "CAMELLIA128-SHA256+TLSv1.2", "CAMELLIA256-SHA256+TLSv1.2",
                    "DES-CBC-MD5+SSLv2", "DES-CBC3-MD5+SSLv2",
                    "DH-DSS-AES128-GCM-SHA256+TLSv1.2",
                    "DH-DSS-AES256-GCM-SHA384+TLSv1.2",
                    "DH-DSS-AES128-SHA+SSLv3", "DH-DSS-AES128-SHA256+TLSv1.2",
                    "DH-DSS-AES256-SHA+SSLv3", "DH-DSS-AES256-SHA256+TLSv1.2",
                    ...
                    "DH-DSS-DES-CBC-SHA+SSLv3", "DH-DSS-DES-CBC3-SHA+SSLv3",
                    "DH-DSS-SEED-SHA+SSLv3", "DH-RSA-AES128-GCM-SHA256+TLSv1.2",
                    "DH-RSA-AES256-GCM-SHA384+TLSv1.2",
                    "DH-RSA-AES128-SHA+SSLv3", "DH-RSA-AES128-SHA256+TLSv1.2",
                    "DH-RSA-AES256-SHA+SSLv3", "DH-RSA-AES256-SHA256+TLSv1.2",
                    ...
                    "DH-RSA-DES-CBC-SHA+SSLv3", "DH-RSA-DES-CBC3-SHA+SSLv3",
                    "DH-RSA-SEED-SHA+SSLv3", "DHE-DSS-CAMELLIA128-SHA+SSLv3",
                    "DHE-DSS-CAMELLIA128-SHA256+TLSv1.2",
                    "DHE-DSS-CAMELLIA256-SHA+SSLv3",
                    "DHE-DSS-CAMELLIA256-SHA256+TLSv1.2",
                    "DHE-DSS-SEED-SHA+SSLv3", "DHE-PSK-3DES-EDE-CBC-SHA+SSLv3",
                    "DHE-PSK-AES128-CBC-SHA+SSLv3",
                    "DHE-PSK-AES128-CBC-SHA256+TLSv1",
                    "DHE-PSK-AES128-CCM+TLSv1.2", "DHE-PSK-AES128-CCM8+TLSv1.2",
                    "DHE-PSK-AES128-GCM-SHA256+TLSv1.2",
                    "DHE-PSK-AES256-CBC-SHA+SSLv3",
                    "DHE-PSK-AES256-CBC-SHA384+TLSv1",
                    "DHE-PSK-AES256-CCM+TLSv1.2", "DHE-PSK-AES256-CCM8+TLSv1.2",
                    "DHE-PSK-AES256-GCM-SHA384+TLSv1.2",
                    "DHE-PSK-CAMELLIA128-SHA256+TLSv1",
                    "DHE-PSK-CAMELLIA256-SHA384+TLSv1",
                    "DHE-PSK-CHACHA20-POLY1305+TLSv1.2",
                    "DHE-PSK-NULL-SHA+SSLv3", "DHE-PSK-NULL-SHA256+TLSv1",
                    "DHE-PSK-NULL-SHA384+TLSv1", "DHE-PSK-RC4-SHA+SSLv3",
                    "DHE-RSA-AES128-CCM+TLSv1.2", "DHE-RSA-AES128-CCM8+TLSv1.2",
                    "DHE-RSA-AES256-CCM+TLSv1.2", "DHE-RSA-AES256-CCM8+TLSv1.2",
                    ...
                    "ECDHE-PSK-CAMELLIA256-SHA384+TLSv1",
                    "ECDHE-PSK-CHACHA20-POLY1305+TLSv1.2",
                    "ECDHE-PSK-NULL-SHA+SSLv3", "ECDHE-PSK-NULL-SHA256+TLSv1",
                    "ECDHE-PSK-NULL-SHA384+TLSv1", "ECDHE-PSK-RC4-SHA+SSLv3",
                    "ECDHE-RSA-CAMELLIA128-SHA256+TLSv1.2",
                    "ECDHE-RSA-CAMELLIA256-SHA384+TLSv1.2",
                    "ECDHE-RSA-CHACHA20-POLY1305+TLSv1.2",
                    "EXP-DH-DSS-DES-CBC-SHA+SSLv3",
                    "EXP-DH-RSA-DES-CBC-SHA+SSLv3", "EXP-RC2-CBC-MD5+SSLv2",
                    "EXP-RC4-MD5+SSLv2", "IDEA-CBC-MD5+SSLv2",
                    "IDEA-CBC-SHA+SSLv3", "PSK-3DES-EDE-CBC-SHA+SSLv3",
                    "PSK-AES128-CBC-SHA+SSLv3", "PSK-AES128-CBC-SHA256+TLSv1",
                    "PSK-AES128-CCM+TLSv1.2", "PSK-AES128-CCM8+TLSv1.2",
                    "PSK-AES128-GCM-SHA256+TLSv1.2", "PSK-AES256-CBC-SHA+SSLv3",
                    "PSK-AES256-CBC-SHA384+TLSv1", "PSK-AES256-CCM+TLSv1.2",
                    "PSK-AES256-CCM8+TLSv1.2", "PSK-AES256-GCM-SHA384+TLSv1.2",
                    "PSK-CAMELLIA128-SHA256+TLSv1",
                    "PSK-CAMELLIA256-SHA384+TLSv1",
                    "PSK-CHACHA20-POLY1305+TLSv1.2", "PSK-NULL-SHA+SSLv3",
                    "PSK-NULL-SHA256+TLSv1", "PSK-NULL-SHA384+TLSv1",
                    "PSK-RC4-SHA+SSLv3", "RC2-CBC-MD5+SSLv2", "RC4-MD5+SSLv2",
                    ...
                    "RSA-PSK-CAMELLIA256-SHA384+TLSv1",
                    "RSA-PSK-CHACHA20-POLY1305+TLSv1.2",
                    "RSA-PSK-NULL-SHA+SSLv3", "RSA-PSK-NULL-SHA256+TLSv1",
                    "RSA-PSK-NULL-SHA384+TLSv1", "RSA-PSK-RC4-SHA+SSLv3",
                    "SEED-SHA+SSLv3", "SRP-AES-128-CBC-SHA+SSLv3",
                    "SRP-AES-256-CBC-SHA+SSLv3", "SRP-3DES-EDE-CBC-SHA+SSLv3",
    ...
    private static Set<String> REGISTERED_NAMES = Collections.unmodifiableSet(
            new HashSet<>(Arrays.asList("TLS_NULL_WITH_NULL_NULL",
                    ...
                    "TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5",
                    "TLS_KRB5_EXPORT_WITH_RC2_CBC_40_MD5",
                    "TLS_KRB5_EXPORT_WITH_RC4_40_MD5", "TLS_PSK_WITH_NULL_SHA",
                    "TLS_DHE_PSK_WITH_NULL_SHA", "TLS_RSA_PSK_WITH_NULL_SHA",
                    "TLS_RSA_WITH_AES_128_CBC_SHA",
                    "TLS_DH_DSS_WITH_AES_128_CBC_SHA",
                    "TLS_DH_RSA_WITH_AES_128_CBC_SHA",
                    "TLS_DHE_DSS_WITH_AES_128_CBC_SHA",
                    ...
                    "TLS_RSA_WITH_AES_128_CCM_8", "TLS_RSA_WITH_AES_256_CCM_8",
