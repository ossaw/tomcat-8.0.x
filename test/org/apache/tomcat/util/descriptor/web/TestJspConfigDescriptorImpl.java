...
public class TestJspConfigDescriptorImpl {
    ...
    public void testTaglibsAreIsolate() {
        ...
        List<JspPropertyGroupDescriptor> propertyGroups = Collections
                .emptyList();
        JspConfigDescriptor descriptor = new JspConfigDescriptorImpl(
    ...
    public void testPropertyGroupsAreIsolate() {
        ...
        propertyGroups.add(new JspPropertyGroupDescriptorImpl(
