...
public class TestCookieParsing extends TomcatBaseTest {
    ...
    private static final String[] COOKIES_WITH_NAME_ONLY = new String[] { "bob",
            "bob=" };
    ...
    public void testRfc6265Equals() throws Exception {
        ...
        TestCookieParsingClient client = new TestCookieParsingClient(
                new Rfc6265CookieProcessor(), COOKIES_WITH_EQUALS, concat(
                        COOKIES_WITH_EQUALS));
        client.doRequest();
    }
    ...
    private void doTestLegacySeps(boolean seps, boolean fwdSlash)
            throws Exception {
        LegacyCookieProcessor legacyCookieProcessor = new LegacyCookieProcessor();
    ...
    public void testRfc6265Seps() throws Exception {
        // Always allows equals
        TestCookieParsingClient client = new TestCookieParsingClient(
                new Rfc6265CookieProcessor(), COOKIES_WITH_SEPS, concat(
                        COOKIES_WITH_SEPS));
        client.doRequest();
    }
    ...
    public void testRfc6265PreserveHeader() throws Exception {
        // Always allows equals
        TestCookieParsingClient client = new TestCookieParsingClient(
                new Rfc6265CookieProcessor(), true, COOKIES_WITH_QUOTES, concat(
                        COOKIES_WITH_QUOTES));
        client.doRequest();
    }
        ...
        protected void service(HttpServletRequest req, HttpServletResponse resp)
            ...
            if (cookies != null) {
                for (Cookie cookie : cookies) {
                    resp.getWriter().write(cookie.getName() + "=" + cookie
                            .getValue());
                }
            }
            resp.flushBuffer();
