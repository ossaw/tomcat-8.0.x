...
public class TesterLeakingServlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        if (counterList == null) {
            log.info("Adding thread local to thread " + Thread.currentThread()
                    .getName());
        ...
        counter.increment();
        response.getWriter().println("The current thread served this servlet "
