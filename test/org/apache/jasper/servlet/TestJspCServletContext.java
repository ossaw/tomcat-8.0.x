...
public class TestJspCServletContext {
    ...
    public void testWebapp() throws Exception {
        ...
        JspCServletContext context = new JspCServletContext(null, appDir.toURI()
                .toURL(), null, false, false);
        ...
        Iterator<JspPropertyGroupDescriptor> groupIterator = propertyGroups
                .iterator();
        JspPropertyGroupDescriptor groupDescriptor;

        groupDescriptor = groupIterator.next();
        Assert.assertEquals("text/plain", groupDescriptor
