...
public class TestReflectionUtil {
    ...
    public void testBug54370a() {
        ReflectionUtil.getMethod(null, BASE, "testA", new Class[] { null,
    ...
    public void testBug54370b() {
        ReflectionUtil.getMethod(null, BASE, "testB", new Class[] { null,
                String.class }, new Object[] { null, "" });
    }

    @Test
    public void testBug54370c() {
        ReflectionUtil.getMethod(null, BASE, "testC", new Class[] { null },
                new Object[] { null });
    }

    @Test
    public void testBug54370d() {
        ReflectionUtil.getMethod(null, BASE, "testD", new Class[] { null },
                new Object[] { null });
    }
}
