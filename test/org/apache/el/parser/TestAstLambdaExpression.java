...
public class TestAstLambdaExpression {
    ...
    public void testSpec04() {
        ELProcessor processor = new ELProcessor();
        Object result = processor.getValue("v = (x,y)->x+y; v(3,4)",
                Integer.class);
    ...
    public void testSpec05() {
        ...
        Object result = processor.getValue(
                "fact = n -> n==0? 1: n*fact(n-1); fact(5)", Integer.class);
    ...
    public void testNested02() {
        ELProcessor processor = new ELProcessor();
        Object result = processor.getValue("(()->y->()->2-y)()(1)()",
                Integer.class);
        Assert.assertEquals(Integer.valueOf(1), result);
    }
    ...
    public void testNested04() {
        ELProcessor processor = new ELProcessor();
        Object result = processor.getValue("(()->y->()->x->x-y)()(1)()(2)",
                Integer.class);
        Assert.assertEquals(Integer.valueOf(1), result);
    }
    ...
    public void testLambdaAsFunction01() {
        ELProcessor processor = new ELProcessor();
        Object result = processor.getValue("v = (x->y->x-y); v(2)(1)",
                Integer.class);
        Assert.assertEquals(Integer.valueOf(1), result);
    }
    ...
    public void testLambdaAsFunction02() {
        ELProcessor processor = new ELProcessor();
        Object result = processor.getValue("v = (()->y->2-y); v()(1)",
                Integer.class);
        Assert.assertEquals(Integer.valueOf(1), result);
    }
    ...
    public void testLambdaAsFunction07() {
        ELProcessor processor = new ELProcessor();
        Object result = processor.getValue(
                "v = (()->y->()->()->x->x-y); v()(1)()(3)(2)", Integer.class);
        Assert.assertEquals(Integer.valueOf(1), result);
    }
}
