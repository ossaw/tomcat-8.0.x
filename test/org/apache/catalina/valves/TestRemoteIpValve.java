...
public class TestRemoteIpValve {
    ...
    public void testInvokeAllProxiesAreTrusted() throws Exception {
        ...
        // VERIFY
        String actualXForwardedFor = remoteAddrAndHostTrackerValve
                .getForwardedFor();
        assertNull("all proxies are trusted, x-forwarded-for must be null",
                actualXForwardedFor);

        String actualXForwardedBy = remoteAddrAndHostTrackerValve
                .getForwardedBy();
        assertEquals(
    ...
    public void test172dash12InternalProxies() throws Exception {
        ...
        request.setRemoteHost("remote-host-original-value");
        request.getCoyoteRequest().getMimeHeaders().addValue("x-forwarded-for")
                .setString("209.244.0.3");
        request.getCoyoteRequest().getMimeHeaders().addValue(
                "x-forwarded-proto").setString("https");
        ...
        String actualPostInvokeRemoteAddr = remoteAddrAndHostTrackerValve
                .getRemoteAddr();
        ...
        actualPostInvokeRemoteAddr = remoteAddrAndHostTrackerValve
                .getRemoteAddr();
        assertEquals("postInvoke remoteAddr", "209.244.0.3",
                actualPostInvokeRemoteAddr);
    ...
    public void testInvokeXforwardedProtoSaysHttpForIncomingHttpsRequest()
        ...
        // protocol
        request.getCoyoteRequest().getMimeHeaders().addValue(
                "x-forwarded-proto").setString("http");
    ...
    public void testInvokeNotAllowedRemoteAddr() throws Exception {
        ...
        String actualPostInvokeRemoteHost = request.getRemoteHost();
        assertEquals("postInvoke remoteAddr", "not-allowed-internal-proxy-host",
                actualPostInvokeRemoteHost);
    }
    ...
    public void testCommaDelimitedListToStringArray() {
        String[] actual = RemoteIpValve.commaDelimitedListToStringArray(
    ...
    public void testRequestAttributesForAccessLog() throws Exception {
        ...
        // VERIFY
        Assert.assertEquals("org.apache.catalina.AccessLog.ServerPort", Integer
                .valueOf(8080), request.getAttribute(
                        AccessLog.SERVER_PORT_ATTRIBUTE));

        Assert.assertEquals("org.apache.catalina.AccessLog.RemoteAddr",
                "140.211.11.130", request.getAttribute(
                        AccessLog.REMOTE_ADDR_ATTRIBUTE));

        Assert.assertEquals("org.apache.catalina.AccessLog.RemoteHost",
                "140.211.11.130", request.getAttribute(
                        AccessLog.REMOTE_HOST_ATTRIBUTE));
    }
