...
public class CoordinationDemo {
    ...
    public String getHeader() {
        ...
        buf.append(rightfill("===" + new java.sql.Timestamp(System
                .currentTimeMillis()).toString(), SCREEN_WIDTH, "="));
        buf.append("\n");
        return buf.toString();
    }
    ...
    private static void usage() {
        ...
        System.out.println(
                "\tjava o.a.c.t.d.CoordinationDemo -> starts demo single threaded start/stop with 5 channels");
        System.out.println(
    ...
    public static class Status {
        ...
        public String getStatusLine() {
            ...
            if (channel != null) {
                ...
                coord = interceptor != null && interceptor
                        .getCoordinator() != null ? interceptor.getCoordinator()
                                .getName() : "";
                if (interceptor != null) {
                    viewId = getByteString(interceptor.getViewId() != null
                            ? interceptor.getViewId().getBytes()
                            : new byte[0]);
