...
public class EchoRpcTest implements RpcCallback, Runnable {
     ...
     * @param sender Member
     *               TODO Implement this
     *               org.apache.catalina.tribes.tipis.RpcCallback
     *               method
     */
    @Override
    public void leftOver(Serializable msg, Member sender) {
        System.out.println("Received a left over message from [" + sender
                .getName() + "] with data [" + msg + "]");
    }
    ...
    public Serializable replyRequest(Serializable msg, Member sender) {
        System.out.println("Received a reply request message from [" + sender
                .getName() + "] with data [" + msg + "]");
    ...
    public static void main(String[] args) throws Exception {
        ...
        ManagedChannel channel = (ManagedChannel) ChannelCreator.createChannel(
                args);
        EchoRpcTest test = new EchoRpcTest(channel, name, count, message, pause,
                options, timeout);
