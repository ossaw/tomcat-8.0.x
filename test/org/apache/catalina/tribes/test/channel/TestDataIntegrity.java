...
public class TestDataIntegrity {
    ...
    public void testDataSendNO_ACK() throws Exception {
        ...
        long start = System.currentTimeMillis();
        while ((System.currentTimeMillis() - start) < 15000 && msgCount
                * threadCount != listener1.count)
            Thread.sleep(500);
    ...
    public void testDataSendASYNCM() throws Exception {
        ...
        //sleep for 50 sec, let the other messages in
        long start = System.currentTimeMillis();
        while ((System.currentTimeMillis() - start) < 25000 && msgCount
                * threadCount != listener1.count)
            Thread.sleep(500);
    ...
    public void testDataSendASYNC() throws Exception {
        ...
        for (int i = 0; i < msgCount; i++)
            channel1.send(new Member[] { channel2.getLocalMember(false) }, Data
                    .createRandomData(), Channel.SEND_OPTIONS_ASYNCHRONOUS);
        //sleep for 50 sec, let the other messages in
        long start = System.currentTimeMillis();
    ...
    public void testDataSendACK() throws Exception {
        ...
        for (int i = 0; i < msgCount; i++)
            channel1.send(new Member[] { channel2.getLocalMember(false) }, Data
                    .createRandomData(), Channel.SEND_OPTIONS_USE_ACK);
        Thread.sleep(250);
    ...
    public void testDataSendSYNCACK() throws Exception {
        ...
        for (int i = 0; i < msgCount; i++)
            channel1.send(new Member[] { channel2.getLocalMember(false) }, Data
                    .createRandomData(), Channel.SEND_OPTIONS_SYNCHRONIZED_ACK
