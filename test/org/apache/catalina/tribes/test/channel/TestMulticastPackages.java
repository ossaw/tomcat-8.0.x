...
public class TestMulticastPackages {
    ...
    public void testSingleDataSendNO_ACK() throws Exception {
        ...
        channel1.send(new Member[] { channel2.getLocalMember(false) }, Data
                .createRandomData(1024), Channel.SEND_OPTIONS_MULTICAST);
        Thread.sleep(500);
    ...
    public void testDataSendASYNCM() throws Exception {
        ...
        while ((System.currentTimeMillis() - start) < 25000 && msgCount
                * threadCount != listener1.count.get())
            Thread.sleep(500);
    ...
    public void testDataSendASYNC() throws Exception {
        ...
        for (int i = 0; i < msgCount; i++)
            channel1.send(new Member[] { channel2.getLocalMember(false) }, Data
                    .createRandomData(1024), Channel.SEND_OPTIONS_ASYNCHRONOUS
                            | Channel.SEND_OPTIONS_MULTICAST);
        //sleep for 50 sec, let the other messages in
        long start = System.currentTimeMillis();
    ...
    public void testDataSendACK() throws Exception {
        ...
        for (int i = 0; i < msgCount; i++)
            channel1.send(new Member[] { channel2.getLocalMember(false) }, Data
                    .createRandomData(1024), Channel.SEND_OPTIONS_USE_ACK
                            | Channel.SEND_OPTIONS_MULTICAST);
        Thread.sleep(250);
