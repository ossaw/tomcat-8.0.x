...
public class TestELProcessor {
    ...
    public void testDefineFunctionMethod01() throws Exception {
        ELProcessor elp = new ELProcessor();
        elp.defineFunction("fn", "toBoolean", Boolean.class.getMethod("valueOf",
                String.class));
        Assert.assertEquals(Boolean.valueOf(true), elp.eval(
                "fn:toBoolean(true)"));
    }
    ...
    public void testDefineFunctionName02() throws Exception {
        ELProcessor elp = new ELProcessor();
        elp.defineFunction("fn", "test", "java.lang.Integer",
                "Integer valueOf(int)");
    ...
    public void testDefineFunctionName03() throws Exception {
        ...
        ELProcessor elp = new ELProcessor();
        elp.defineFunction("fn", "test", "javax.el.TesterFunctions",
                "void doIt()");
        elp.eval("fn:test()");
    ...
    public void testDefineFunctionName06() throws Exception {
        TesterFunctions.resetCallList();
        ELProcessor elp = new ELProcessor();
        elp.defineFunction("", "", "javax.el.TesterFunctions",
                "void doIt(int)");
        elp.eval("doIt(5)");
        Assert.assertEquals("B", TesterFunctions.getCallList());
    }
    ...
    public void testDefineFunctionName07() throws Exception {
        TesterFunctions.resetCallList();
        ELProcessor elp = new ELProcessor();
        elp.defineFunction("fn", "", "javax.el.TesterFunctions",
                "void doIt(int)");
        elp.eval("fn:doIt(5)");
        Assert.assertEquals("B", TesterFunctions.getCallList());
    }
    ...
    public void testDefineFunctionName10() throws Exception {
        TesterFunctions.resetCallList();
        ELProcessor elp = new ELProcessor();
        elp.defineFunction("fn", "test1", "java.lang.Integer",
                "Integer valueOf(int)");
        elp.defineFunction("fn", "test2", "javax.el.TesterFunctions",
                "void doIt(Integer[])");
    ...
    public void testDefineFunctionName11() throws Exception {
        ...
        elp.defineFunction("fn", "test2", "javax.el.TesterFunctions",
                "void doIt(Integer[][])");
        elp.eval(
                "fn:test2([[fn:test1(1), fn:test1(2)].stream().toArray()].stream().toArray())");
    ...
    public void testPrimitiveArray01() {
        ...
        Object result = elp.eval(
                "bean02.setValueC(bean01.valueB);bean02.valueC");
