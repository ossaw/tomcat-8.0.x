...
public class SessionUtils {
     ...
     */
    private static final String[] USER_TEST_ATTRIBUTES = new String[] { "Login",
     ...
     * JSF check the browser meta tag "accept languages" to choose what language
     * to display.
     * 
     * @param in_session
     * @return String
    ...
    public static Locale guessLocaleFromSession(final HttpSession in_session) {
        ...
        try {
            ...
            for (Enumeration<String> enumeration = in_session
                ...
                if (name.indexOf("tapestry") > -1 && name.indexOf("engine") > -1 //$NON-NLS-1$//$NON-NLS-2$
                        && null != in_session.getAttribute(name)) {
            ...
            if (tapestryArray.size() == 1) {
                ...
                if (null != probableEngine) {
                    try {
                        Method readMethod = probableEngine.getClass().getMethod(
                                "getLocale", (Class<?>[]) null);//$NON-NLS-1$
    ...
    public static Object guessUserFromSession(final Session in_session) {
        ...
        try {
            ...
            for (Enumeration<String> enumeration = httpSession
                ...
                if (null != obj && (obj instanceof Principal
    ...
    public static long getInactiveTimeForSession(Session in_session) {
        try {
            long diffMilliSeconds = System.currentTimeMillis() - in_session
                    .getThisAccessedTime();
            return diffMilliSeconds;
        } catch (IllegalStateException ise) {
            //ignore: invalidated session
