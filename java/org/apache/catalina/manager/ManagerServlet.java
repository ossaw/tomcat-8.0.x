...
public class ManagerServlet extends HttpServlet implements ContainerServlet {
    ...
    public void setWrapper(Wrapper wrapper) {
        ...
        if (wrapper == null) {
            ...
            String name = engine.getName() + ":type=Deployer,host=" + host
                    .getName();
            try {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ((request.getParameter("update") != null) && (request.getParameter(
                "update").equals("true"))) {
            update = true;
        }
    ...
    protected void sslConnectorCiphers(PrintWriter writer,
        ...
        for (Map.Entry<String, Set<String>> entry : connectorCiphers
                .entrySet()) {
    ...
    protected synchronized void save(PrintWriter writer, String path,
        ...
        try {
            ...
            writer.println(smClient.getString("managerServlet.exception", e
                    .toString()));
            return;
        }
        ...
        if ((path == null) || path.length() == 0 || !path.startsWith("/")) {
            ...
            try {
                mBeanServer.invoke(storeConfigOname, "store", new Object[] {
                        context }, new String[] { "java.lang.String" });
    ...
    protected void deploy(PrintWriter writer, String config, ContextName cn,
        ...
        try {
            ...
            writer.println(smClient.getString("managerServlet.exception", t
                    .toString()));
        }
    ...
    private void writeDeployResult(PrintWriter writer, StringManager smClient,
        ...
        if (deployed != null && deployed.getConfigured() && deployed.getState()
                .isAvailable()) {
    ...
    protected void list(PrintWriter writer, StringManager smClient) {
        ...
        writer.println(smClient.getString("managerServlet.listed", host
                .getName()));
            ...
            if (context != null) {
                ...
                if (context.getState().isAvailable()) {
                    writer.println(smClient.getString("managerServlet.listitem",
                            displayPath, "running", "" + context.getManager()
                                    .findSessions().length, context
                                            .getDocBase()));
                } else {
                    writer.println(smClient.getString("managerServlet.listitem",
    ...
    protected void reload(PrintWriter writer, ContextName cn,
        ...
        try {
            ...
            context.reload();
            writer.println(smClient.getString("managerServlet.reloaded", cn
                    .getDisplayName()));
        } catch (Throwable t) {
            ExceptionUtils.handleThrowable(t);
    ...
    public static boolean copy(File src, File dest) {
        ...
        try {
            if (src != null && !src.getCanonicalPath().equals(dest
                    .getCanonicalPath())) {
    ...
    protected Map<String, Set<String>> getConnectorCiphers() {
        ...
        for (Connector connector : connectors) {
            ...
            if (Boolean.TRUE.equals(connector.getProperty("SSLEnabled"))) {
                String[] ciphersUsed = (String[]) connector.getProperty(
                        "ciphersUsed");
