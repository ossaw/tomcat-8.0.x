...
public final class HTMLHostManagerServlet extends HostManagerServlet {
    ...
    public void list(HttpServletRequest request, HttpServletResponse response,
        ...
        args[5] = response.encodeURL(request.getContextPath() + "/" + smClient
                .getString("htmlHostManagerServlet.helpManagerFile"));
        ...
        String hostsStart = smClient.getString(
                "htmlHostManagerServlet.hostsStart");
        String hostsStop = smClient.getString(
                "htmlHostManagerServlet.hostsStop");
        String hostsRemove = smClient.getString(
                "htmlHostManagerServlet.hostsRemove");
