...
public abstract class SessionIdGeneratorBase extends LifecycleBase implements
        SessionIdGenerator {
    ...
    private SecureRandom createSecureRandom() {
        ...
        if (result == null) {
            ...
            try {
                if (secureRandomProvider != null && secureRandomProvider
                        .length() > 0) {
        ...
        if ((t2 - t1) > 100)
            log.info(sm.getString("sessionIdGeneratorBase.createRandom", result
                    .getAlgorithm(), Long.valueOf(t2 - t1)));
        return result;
    }
