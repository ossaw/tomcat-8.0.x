 ...
 * successfully
 * authenticates to one web application is propagated to other web applications
 * and
...
public class ClusterSingleSignOn extends SingleSignOn implements ClusterValve,
    ...
    private static final StringManager sm = StringManager.getManager(
            ClusterSingleSignOn.class.getPackage().getName());
        ...
        try {
            ...
            if (cluster == null) {
                throw new LifecycleException(sm.getString(
                        "clusterSingleSignOn.nocluster"));
            }

            ClassLoader[] cls = new ClassLoader[] { this.getClass()
                    .getClassLoader() };

            ReplicatedMap<String, SingleSignOnEntry> cache = new ReplicatedMap<>(
                    this, cluster.getChannel(), rpcTimeout, cluster
                            .getClusterName() + "-SSO-cache", cls,
            ...
            throw new LifecycleException(sm.getString(
                    "clusterSingleSignOn.clusterLoad.fail"), t);
        }
