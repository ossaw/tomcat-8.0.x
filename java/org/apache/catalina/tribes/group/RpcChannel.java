...
public class RpcChannel implements ChannelListener {
    ...
    protected static final StringManager sm = StringManager.getManager(
            RpcChannel.class.getPackage().getName());
    ...
    public Response[] send(Member[] destination, Serializable message,
        ...
        RpcCollectorKey key = new RpcCollectorKey(UUIDGenerator.randomUUID(
                false));
    ...
    public void messageReceived(Serializable msg, Member sender) {
        ...
        if (rmsg.reply) {
            ...
            final ExtendedRpcCallback excallback = (callback instanceof ExtendedRpcCallback)
