...
public class GroupChannel extends ChannelInterceptorBase implements
    ...
    protected static final StringManager sm = StringManager.getManager(
            GroupChannel.class.getPackage().getName());
    ...
    public void heartbeat() {
        super.heartbeat();
        Iterator<MembershipListener> membershipListenerIterator = membershipListeners
                .iterator();
        ...
        Iterator<ChannelListener> channelListenerIterator = channelListeners
                .iterator();
     ...
     * @param options     sender options, options can trigger guarantee levels
     *                    and different
    ...
    public UniqueId send(Member[] destination, Serializable msg, int options,
        ...
        try {
            ...
            if (Logs.MESSAGES.isTraceEnabled()) {
                Logs.MESSAGES.trace("GroupChannel - Sent msg:" + new UniqueId(
                        data.getUniqueId()) + " at " + new java.sql.Timestamp(
                                System.currentTimeMillis()) + " to " + Arrays
    ...
    public void messageReceived(ChannelMessage msg) {
        ...
        try {
            ...
            if ((msg.getOptions()
                    & SEND_OPTIONS_BYTE_MESSAGE) == SEND_OPTIONS_BYTE_MESSAGE) {
    ...
    protected synchronized void setupDefaultStack() throws ChannelException {
        if (getFirstInterceptor() != null && ((getFirstInterceptor()
                .getNext() instanceof ChannelCoordinator))) {
    ...
    protected void checkOptionFlags() throws ChannelException {
        ...
        if (conflicts.length() > 0)
            throw new ChannelException(sm.getString(
                    "groupChannel.optionFlag.conflict", conflicts.toString()));
    ...
    public void addChannelListener(ChannelListener channelListener) {
        if (!this.channelListeners.contains(channelListener)) {
            ...
            throw new IllegalArgumentException(sm.getString(
                    "groupChannel.listener.alreadyExist", channelListener,
     ...
     * if <code>setHeartbeat(true)</code> is invoked then the channel will start
     * an internal
