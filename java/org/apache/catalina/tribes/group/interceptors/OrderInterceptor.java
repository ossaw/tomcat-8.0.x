 ...
 * using this with the replicationMode="fastasynchqueue" as this mode guarantees
 * ordering.<BR>
 ...
 * and the queue might become rather large. If this is the case, then you might
 * want to set
 ...
 * interceptor what to
 * do when a message has expired or the queue has grown larger than the maxQueue
 * value.
...
public class OrderInterceptor extends ChannelInterceptorBase {
    protected static final StringManager sm = StringManager.getManager(
            OrderInterceptor.class.getPackage().getName());
    ...
    public void messageReceived(ChannelMessage msg) {
        ...
        msg.getMessage().trim(4);
        MessageOrder order = new MessageOrder(msgnr, (ChannelMessage) msg
                .deepclone());
    ...
    protected static class MessageOrder {
        ...
        public static MessageOrder add(MessageOrder head, MessageOrder add) {
            ...
            if (iter.getMsgNr() < add.getMsgNr()) {
                ...
                throw new ArithmeticException(sm.getString(
                        "orderInterceptor.messageAdded.sameCounter"));
            }
