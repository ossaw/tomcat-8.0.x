 ...
 * and assembles them on the other end.
...
public class FragmentationInterceptor extends ChannelInterceptorBase {
    private static final Log log = LogFactory.getLog(
            FragmentationInterceptor.class);
    protected static final StringManager sm = StringManager.getManager(
            FragmentationInterceptor.class.getPackage().getName());
    ...
    public static class FragCollection {
        ...
        public FragCollection(ChannelMessage msg) {
            ...
            int count = XByteBuffer.toInt(msg.getMessage().getBytesDirect(), msg
        ...
        public ChannelMessage assemble() {
            if (!complete())
                throw new IllegalStateException(sm.getString(
                        "fragmentationInterceptor.fragments.missing"));
            int buffersize = 0;
            ...
            msg.setMessage(buf);
            for (int i = 0; i < frags.length; i++) {
                msg.getMessage().append(frags[i].getBytesDirect(), 0, frags[i]
                        .getLength());
            }
            return msg;
        }
