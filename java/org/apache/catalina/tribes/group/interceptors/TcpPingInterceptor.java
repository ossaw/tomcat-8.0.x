...
public class TcpPingInterceptor extends ChannelInterceptorBase {
    ...
    protected static final StringManager sm = StringManager.getManager(
            TcpPingInterceptor.class.getPackage().getName());

    protected static final byte[] TCP_PING_DATA = new byte[] { 79, -89, 115, 72,
            121, -33, 67, -55, -97, 111, -119, -128, -95, 91, 7, 20, 125, -39,
            82, 91, -21, -33, 67, -102, -73, 126, -66, -113, -127, 103, 30, -74,
            55, 21, -66, -121, 69, 33, 76, -88, -65, 10, 77, 19, 83, 56, 21, 50,
            85, -10, -108, -73, 58, -33, 33, 120, -111, 4, 125, -41, 114, -124,
            -64, -43 };
    ...
    public void messageReceived(ChannelMessage msg) {
        ...
        if (okToProcess(msg.getOptions())) {
            ...
            process = ((msg.getMessage().getLength() != TCP_PING_DATA.length)
                    || (!Arrays.equals(TCP_PING_DATA, msg.getMessage()
                            .getBytes())));
        } //end if
            ...
            while (running) {
                try {
                    ...
                    log.warn(sm.getString(
                            "tcpPingInterceptor.pingFailed.pingThread"), x);
                }
            }
        }
    }
