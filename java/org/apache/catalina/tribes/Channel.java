...
public interface Channel {
     ...
     * implementation
     * this will open a datagram socket and join a group and broadcast the local
     * member information
     * 
     * @see #start(int)
     * @see #stop(int)
    ...
    /**
     * Send options. When a message is sent with this flag on
     * the system sends a UDP message on the Multicast address instead of UDP or
     * TCP to individual addresses
     * 
     * @see #send(Member[], Serializable , int)
     * @see #send(Member[], Serializable, int, ErrorHandler)
     */
     ...
     *                    is that a membership change can occur and at that time
     *                    the application is uncertain what group the message
