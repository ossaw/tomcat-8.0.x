...
public class ChannelData implements ChannelMessage {
    ...
    public byte[] getDataPackage(byte[] data, int offset) {
        ...
        System.arraycopy(message.getBytesDirect(), 0, data, offset, message
                .getLength());
    ...
    public boolean equals(Object o) {
        if (o instanceof ChannelData) {
            return Arrays.equals(getUniqueId(), ((ChannelData) o)
                    .getUniqueId());
        } else
            return false;
    }
    ...
    public static boolean sendAckSync(int options) {
        return ((Channel.SEND_OPTIONS_USE_ACK
                & options) == Channel.SEND_OPTIONS_USE_ACK)
                && ((Channel.SEND_OPTIONS_SYNCHRONIZED_ACK
                        & options) == Channel.SEND_OPTIONS_SYNCHRONIZED_ACK);
    }
