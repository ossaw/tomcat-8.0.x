...
public class Catalina {
    ...
    private void addClusterRuleSet(Digester digester, String prefix) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                log.debug(sm.getString("catalina.noCluster", e.getClass()
    ...
    public void stopServer(String[] arguments) {
        ...
        if (s.getPort() > 0) {
            try (Socket socket = new Socket(s.getAddress(), s.getPort());
                ...
                log.error(sm.getString("catalina.stopServer.connectException", s
                        .getAddress(), String.valueOf(s.getPort())));
        ...
        try {
            ...
            if (inputStream == null || inputSource == null) {
                if (file == null) {
                    ...
                    log.warn(sm.getString("catalina.configFail", file
                            .getAbsolutePath()));
            ...
            try {
                ...
                log.warn("Catalina.start using " + getConfigFile() + ": " + spe
                        .getMessage());
                return;
            } catch (Exception e) {
