...
public final class Tool {
     ...
     */
    private static final String catalinaHome = System.getProperty(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            classLoader = ClassLoaderFactory.createClassLoader(unpacked.toArray(
                    new File[0]), packed.toArray(new File[0]), null);
        } catch (Throwable t) {
