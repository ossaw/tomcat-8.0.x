 ...
 * JDK 1.3 (with the plug-in <code>jaas.jar</code> file).
 * </p>
 *
 * <p>
 * The value configured for the <code>appName</code> property is passed to
...
public class JAASRealm extends RealmBase {
     ...
     *
     * @param classNamesString a comma-delimited list of fully qualified class
     *                         names.
