...
public final class SecurityUtil {
    ...
    private static final boolean packageDefinitionEnabled = (System.getProperty(
            "package.definition") == null && System.getProperty(
                    "package.access") == null) ? false : true;
     ...
     *                             will
     *                             be called.
     * @param targetParameterTypes <code>Class</code> array used to instantiate
     *                             a
     *                             <code>Method</code> object.
     ...
     */
    public static void doAsPrivilege(final String methodName,
            final Servlet targetObject, final Class<?>[] targetParameterTypes,
            final Object[] targetArguments, Principal principal)
            throws Exception {

        // CometProcessor instances must not be cached as Servlet or
        // NoSuchMethodException will be thrown.
        Class<? extends Servlet> targetType = targetObject instanceof CometProcessor
                ? CometProcessor.class
                : Servlet.class;

        Method method = null;
        Method[] methodsCache = classCache.get(Servlet.class);
        if (methodsCache == null) {
            method = createMethodAndCacheIt(methodsCache, targetType,
     ...
     */
    public static void doAsPrivilege(final String methodName,
            final Filter targetObject) throws Exception {
     ...
     *
     * @param methodName            the method to apply the security restriction
     * @param targetObject          the <code>Filter</code> on which the method
     *                              will
     *                              be called.
     * @param targetParameterTypes  <code>Class</code> array used to instantiate
     *                              a
     ...
     */
    public static void doAsPrivilege(final String methodName,
            final Filter targetObject, final Class<?>[] targetParameterTypes,
            final Object[] targetParameterValues, Principal principal)
            throws Exception {

        // CometFilter instances must not be cached as Filter or
        // NoSuchMethodException will be thrown.
        Class<? extends Filter> targetType = targetObject instanceof CometFilter
                ? CometFilter.class
                : Filter.class;
