...
public class ApplicationContext implements ServletContext {
    ...
    public ServletContext getContext(String uri) {
        ...
        try {
            ...
            if (child == null) {
                ...
                ((Engine) host.getParent()).getService().getMapper().map(hostMB,
                        pathMB, null, mappingData);
    ...
    public String getInitParameter(final String name) {
        ...
        if (Globals.JASPER_XML_VALIDATION_TLD_INIT_PARAM.equals(name) && context
                .getTldValidation()) {
            return "true";
        }
    ...
    public RequestDispatcher getRequestDispatcher(String path) {
        ...
        if (getContext().getDispatchersUseEncodedPaths()) {
            ...
            if (!decodedPath.equals(normalizedPath)) {
                getContext().getLogger().warn(sm.getString(
                        "applicationContext.illegalDispatchPath", path),
    ...
    public void setAttribute(String name, Object value) {
        ...
        if (replaced)
            event = new ServletContextAttributeEvent(context
                    .getServletContext(), name, oldValue);
        else
            event = new ServletContextAttributeEvent(context
                    .getServletContext(), name, value);
     ...
     *                                       method of a
     *                                       {@link ServletContextListener} that
     *                                       was not declared
     *                                       in web.xml, a web-fragment or
     *                                       annotated with
    ...
    private FilterRegistration.Dynamic addFilter(String filterName,
        ...
        if (filterDef == null) {
            ...
            if (filterDef.getFilterName() != null && filterDef
                    .getFilterClass() != null) {
                return null;
            }
        }
    ...
    public <T extends Filter> T createFilter(Class<T> c)
        ...
        try {
            ...
            T filter = (T) context.getInstanceManager().newInstance(c
                    .getName());
            return filter;
    ...
    private ServletRegistration.Dynamic addServlet(String servletName,
        ...
        if (wrapper == null) {
            ...
            if (wrapper.getName() != null && wrapper
    ...
    public <T extends Servlet> T createServlet(Class<T> c)
        ...
        try {
            @SuppressWarnings("unchecked")
            T servlet = (T) context.getInstanceManager().newInstance(c
                    .getName());
    ...
    public void addListener(Class<? extends EventListener> listenerClass) {
        ...
        try {
            ...
            throw new IllegalArgumentException(sm.getString(
                    "applicationContext.addListener.iae.init", listenerClass
                            .getName()), e);
        }
    ...
    public void addListener(String className) {
        ...
        try {
            if (context.getInstanceManager() != null) {
                Object obj = context.getInstanceManager().newInstance(
                        className);
    ...
    public <T extends EventListener> void addListener(T t) {
        ...
        if (t instanceof ServletContextListener) {
            ...
            throw new IllegalArgumentException(sm.getString(
                    "applicationContext.addListener.iae.wrongType", t.getClass()
                            .getName()));
        }
    }
