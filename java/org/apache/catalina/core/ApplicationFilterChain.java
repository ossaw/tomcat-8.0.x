...
final class ApplicationFilterChain implements FilterChain, CometFilterChain {
     ...
     */
    private static final Class<?>[] cometClassType = new Class[] {
            CometEvent.class, CometFilterChain.class };

    /**
     * Static class array used when the SecurityManager is turned on and
     * <code>event</code> is invoked.
     */
    private static final Class<?>[] classTypeUsedInEvent = new Class[] {
            CometEvent.class };
    ...
    private void internalDoFilter(ServletRequest request,
        ...
        try {
            ...
            if (request.isAsyncSupported() && !support.getWrapper()
                    .isAsyncSupported()) {
                request.setAttribute(Globals.ASYNC_SUPPORTED_ATTR,
                        Boolean.FALSE);
            }
