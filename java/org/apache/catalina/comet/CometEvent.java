...
public interface CometEvent {
    ...
    public enum EventSubType {
        TIMEOUT, CLIENT_DISCONNECT, IOEXCEPTION, WEBAPP_RELOAD, SERVER_SHUTDOWN,
        SESSION_END
    }
     ...
     * effect.
     *
     * @param timeout The timeout in milliseconds for this connection, must be a
     *                positive value, larger than 0
     * @throws IOException                   An IOException may be thrown to
     *                                       indicate an IO error,
     *                                       or that the EOF has been reached on
     *                                       the connection
     * @throws ServletException              An exception has occurred, as
     *                                       specified by the root
     *                                       cause
     * @throws UnsupportedOperationException if per connection timeout is not
     *                                       supported, either at all or at this
     *                                       phase
     *                                       of the invocation.
     */
