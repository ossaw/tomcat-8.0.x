 ...
 * <code>org.apache.catalina.deploy.NamingResourcesImpl</code> component.
 * </p>
 *
 * @author Amy Roh
 */
public class NamingResourcesMBean extends BaseModelMBean {
     ...
     */
    protected final ManagedBean managed = registry.findManagedBean(
            "NamingResources");
    ...
    public String[] getEnvironments() {
        ContextEnvironment[] envs = ((NamingResourcesImpl) this.resource)
                .findEnvironments();
    ...
    public String[] getResources() {
        ...
        ContextResource[] resources = ((NamingResourcesImpl) this.resource)
                .findResources();
        ArrayList<String> results = new ArrayList<>();
    ...
    public String[] getResourceLinks() {
        ...
        ContextResourceLink[] resourceLinks = ((NamingResourcesImpl) this.resource)
                .findResourceLinks();
        ArrayList<String> results = new ArrayList<>();
        for (int i = 0; i < resourceLinks.length; i++) {
            try {
                ObjectName oname = MBeanUtils.createObjectName(managed
                        .getDomain(), resourceLinks[i]);
                results.add(oname.toString());
            } catch (MalformedObjectNameException e) {
                IllegalArgumentException iae = new IllegalArgumentException(
                        "Cannot create object name for resource "
    ...
    public String addResourceLink(String resourceLinkName, String type)
        ...
        ContextResourceLink resourceLink = nresources.findResourceLink(
                resourceLinkName);
