...
public class MBeanUtils {
    ...
    public static ObjectName createObjectName(String domain,
        ...
        if (container instanceof Server) {
            ...
            name = new ObjectName(domain + ":type=Environment"
                    ...
                    + ",context=" + cn.getDisplayName() + ",name=" + environment
                            .getName());
        }
        return (name);
    ...
    public static ObjectName createObjectName(String domain,
        ...
        if (container instanceof Server) {
            ...
            name = new ObjectName(domain + ":type=Resource"
                    + ",resourcetype=Context,host=" + host.getName()
                    + ",context=" + cn.getDisplayName() + ",class=" + resource
                            .getType() + ",name=" + quotedResourceName);
        }
    ...
    public static ObjectName createObjectName(String domain,
        ...
        ObjectName name = null;
        String quotedResourceLinkName = ObjectName.quote(resourceLink
                .getName());
    ...
    static ObjectName createObjectName(String domain, Group group)
        ...
        ObjectName name = null;
        name = new ObjectName(domain + ":type=Group,groupname=" + ObjectName
                .quote(group.getGroupname()) + ",database=" + group
    ...
    static ObjectName createObjectName(String domain, Role role)
        ...
        ObjectName name = new ObjectName(domain + ":type=Role,rolename="
                + ObjectName.quote(role.getRolename()) + ",database=" + role
                        .getUserDatabase().getId());
        return name;
    }
    ...
    static ObjectName createObjectName(String domain, User user)
        ...
        ObjectName name = new ObjectName(domain + ":type=User,username="
                + ObjectName.quote(user.getUsername()) + ",database=" + user
                        .getUserDatabase().getId());
        return name;
    }
