...
public class MBeanFactory {
    ...
    private Service getService(ObjectName oname) throws Exception {
        ...
        if (service == null || !service.getObjectName().getDomain().equals(
                domain)) {
    ...
    public String createStandardContext(String parent, String path,
        ...
        if (mserver.isRegistered(deployer)) {
            ...
            mserver.invoke(deployer, "addServiced", new Object[] {
                    contextName }, new String[] { "java.lang.String" });
     ...
     * @exception Exception if an MBean cannot be created or registered
     */
    public String createStandardHost(String parent, String name, String appBase,
            boolean autoDeploy, boolean deployOnStartup, boolean deployXML,
            boolean unpackWARs) throws Exception {
    ...
    public void removeConnector(String name) throws Exception {
        ...
        for (int i = 0; i < conns.length; i++) {
            String connAddress = String.valueOf(conns[i].getProperty(
                    "address"));
