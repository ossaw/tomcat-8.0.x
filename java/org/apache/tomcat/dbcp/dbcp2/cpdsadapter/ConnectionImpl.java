...
class ConnectionImpl extends DelegatingConnection<Connection> {
     ...
     *
     * @param pooledConnection                    The PooledConnection that is
     *                                            calling the ctor.
     * @param connection                          The JDBC 1.x Connection to
     *                                            wrap.
     * @param accessToUnderlyingConnectionAllowed if true, then access is
     *                                            allowed to the underlying
     *                                            connection
     */
    ...
    public PreparedStatement prepareStatement(final String sql)
        ...
        checkOpen();
        try {
            return new DelegatingPreparedStatement(this, pooledConnection
