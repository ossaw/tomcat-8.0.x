 ...
 * @since 2.0
 */
public class DelegatingPreparedStatement extends DelegatingStatement implements
        PreparedStatement {
    ...
    public ResultSet executeQuery() throws SQLException {
        ...
        try {
            return DelegatingResultSet.wrapResultSet(this,
                    ((PreparedStatement) getDelegate()).executeQuery());
    ...
    public void setNull(final int parameterIndex, final int sqlType)
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setNull(parameterIndex,
                    sqlType);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    public void setBigDecimal(final int parameterIndex, final BigDecimal x)
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setBigDecimal(parameterIndex,
                    x);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    public void setAsciiStream(final int parameterIndex, final InputStream x,
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setAsciiStream(parameterIndex,
                    x, length);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    public void setUnicodeStream(final int parameterIndex, final InputStream x,
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setUnicodeStream(parameterIndex,
                    x, length);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    public void setBinaryStream(final int parameterIndex, final InputStream x,
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setBinaryStream(parameterIndex,
                    x, length);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    public void setCharacterStream(final int parameterIndex,
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setCharacterStream(
    ...
    public void setNull(final int paramIndex, final int sqlType,
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setNull(paramIndex, sqlType,
                    typeName);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    @Override
    public void setRowId(final int parameterIndex, final RowId value)
            throws SQLException {
        checkOpen();
        try {
    ...
    public void setNString(final int parameterIndex, final String value)
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setNString(parameterIndex,
                    value);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    public void setNCharacterStream(final int parameterIndex,
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setNCharacterStream(
    ...
    public void setBlob(final int parameterIndex, final InputStream inputStream,
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setBlob(parameterIndex,
                    inputStream, length);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    @Override
    public void setSQLXML(final int parameterIndex, final SQLXML value)
            throws SQLException {
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setSQLXML(parameterIndex,
                    value);
        } catch (final SQLException e) {
            handleException(e);
        }
    ...
    public void setNClob(final int parameterIndex, final Reader reader)
        ...
        checkOpen();
        try {
            ((PreparedStatement) getDelegate()).setNClob(parameterIndex,
                    reader);
        } catch (final SQLException e) {
            handleException(e);
        }
