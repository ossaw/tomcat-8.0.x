...
/**
 * <p>
 * Holds a username, password pair. Serves as a poolable object key for the
 * KeyedObjectPool
 * backing a SharedPoolDataSource. Two instances with the same username are
 * considered equal.
 * This ensures that there will be only one keyed pool for each user in the
 * pool. The password
 * is used (along with the username) by the KeyedCPDSConnectionFactory when
 * creating new connections.
 * </p>
 *
 * <p>
 * {@link InstanceKeyDataSource#getConnection(String, String)} validates that
 * the password used to create
...
class UserPassKey implements Serializable {
    ...
    public boolean equals(final Object obj) {
        ...
        return this.username == null ? key.username == null
