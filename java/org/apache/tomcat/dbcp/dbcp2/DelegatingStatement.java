...
public class DelegatingStatement extends AbandonedTrace implements Statement {
     ...
     */
    public DelegatingStatement(final DelegatingConnection<?> c,
            final Statement s) {
        super(c);
        _stmt = s;
        _conn = c;
    ...
    protected void checkOpen() throws SQLException {
        if (isClosed()) {
            throw new SQLException(this.getClass().getName()
                    + " with address: \"" + this.toString() + "\" is closed.");
        }
    }
    ...
    public void close() throws SQLException {
        ...
        try {
            try {
                ...
                if (resultSets != null) {
                    final ResultSet[] set = resultSets.toArray(
                            new ResultSet[resultSets.size()]);
    ...
    public ResultSet getResultSet() throws SQLException {
        checkOpen();
        try {
            return DelegatingResultSet.wrapResultSet(this, _stmt
                    .getResultSet());
        } catch (final SQLException e) {
            handleException(e);
            throw new AssertionError();
