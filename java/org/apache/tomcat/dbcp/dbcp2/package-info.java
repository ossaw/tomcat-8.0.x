 ...
 * {@link java.sql.Driver Driver}, or as a {@link javax.sql.DataSource
 * DataSource}.
 * You'll want to create an instance of
 * {@link org.apache.tomcat.dbcp.dbcp2.PoolingDriver} or
 * {@link org.apache.tomcat.dbcp.dbcp2.PoolingDataSource}. When using one of
 * these
 ...
 * {@link org.apache.tomcat.dbcp.dbcp2.PoolingDataSource PoolingDataSource} both
 * expect an
 * {@link org.apache.tomcat.dbcp.pool2.ObjectPool ObjectPool} as an input. Where
 * do I
 * get one of those?
 * </p>
 * <p>
 * A: The {@link org.apache.tomcat.dbcp.pool2.ObjectPool ObjectPool} interface
 * is defined
 ...
 * </p>
 * <p>
 * Q: Ok, I've found an {@link org.apache.tomcat.dbcp.pool2.ObjectPool
 * ObjectPool}
 * implementation that I think suits my connection pooling needs. But it wants
 * a {@link org.apache.tomcat.dbcp.pool2.PooledObjectFactory
 * PooledObjectFactory}.
 ...
 * {@link java.sql.Connection}s created by the
 * {@link org.apache.tomcat.dbcp.dbcp2.ConnectionFactory}
 * and wrap them with classes that implement the pooling behaviour.
 * </p>
 * <p>
 * Several implementations of
 * {@link org.apache.tomcat.dbcp.dbcp2.ConnectionFactory} are
 ...
 * {@link org.apache.tomcat.dbcp.dbcp2.PoolingDataSource}.
 * </p>
 * <p>
 ...
 *         "jdbc:some:connect:string", "username", "password");
 * PoolableConnectionFactory poolableConnectionFactory = new PoolableConnectionFactory(
 *         connectionFactory, connectionPool, null, null, false, true);
 * PoolingDataSource dataSource = new PoolingDataSource(connectionPool);
 * </pre>
 * <p>
 * To create a {@link org.apache.tomcat.dbcp.dbcp2.PoolingDriver}, we do the
 * same thing,
 * except that instead of creating a {@link javax.sql.DataSource} on the last
 * line,
 * we create a {@link org.apache.tomcat.dbcp.dbcp2.PoolingDriver}, and register
 * the
 ...
 * go to the {@link java.sql.DriverManager} to create your
