...
public class PStmtKey {
    ...
    public PStmtKey(final String sql, final String catalog,
        ...
        this(sql, catalog, StatementType.PREPARED_STATEMENT, Integer.valueOf(
                autoGeneratedKeys));
    }

    public PStmtKey(final String sql, final String catalog,
            final StatementType stmtType, final Integer autoGeneratedKeys) {
        _sql = sql;
        _catalog = catalog;
        _stmtType = stmtType;
    ...
    public PStmtKey(final String sql, final int resultSetType,
    ...
    public int hashCode() {
        ...
        result = prime * result + (_resultSetConcurrency == null ? 0
                : _resultSetConcurrency.hashCode());
        result = prime * result + (_resultSetType == null ? 0
                : _resultSetType.hashCode());
