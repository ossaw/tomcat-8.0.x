...
public final class DelegatingResultSet extends AbandonedTrace implements
    ...
    public static ResultSet wrapResultSet(final Statement stmt,
    ...
    public static ResultSet wrapResultSet(final Connection conn,
            final ResultSet rset) {
        if (null == rset) {
            return null;
        }
    ...
    @Override
    public void updateRowId(final int columnIndex, final RowId value)
            throws SQLException {
        try {
    ...
    @Override
    public void updateNClob(final int columnIndex, final NClob value)
            throws SQLException {
        try {
    ...
    @Override
    public void updateSQLXML(final int columnIndex, final SQLXML value)
            throws SQLException {
        try {
