...
class PoolImplUtils {
    ...
    static Class<?> getFactoryType(
            final Class<? extends PooledObjectFactory> factory) {
    ...
    private static <T> Object getGenericType(final Class<T> type,
        ...
        final Class<? extends T> superClazz = (Class<? extends T>) clazz
                .getSuperclass();
        ...
        if (result instanceof Class<?>) {
            ...
            final ParameterizedType superClassType = (ParameterizedType) clazz
                    .getGenericSuperclass();
            return getTypeParameter(clazz, superClassType
                    .getActualTypeArguments()[((Integer) result).intValue()]);
        } else {
     ...
     */
    private static Object getTypeParameter(final Class<?> clazz,
            final Type argType) {
