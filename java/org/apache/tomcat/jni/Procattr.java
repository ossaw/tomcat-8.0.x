...
public class Procattr {
     ...
     *             apr_proc_create()
     *             on platforms where fork() is used. It will never be called on
     *             other
     *             platforms, on those platforms apr_proc_create() will return
     *             the error
     *             in the parent process rather than invoke the callback in the
     *             now-forked
     *             child process.
     */
     ...
     */
    public static native int userSet(long attr, String username,
            String password);
