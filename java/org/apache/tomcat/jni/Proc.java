...
public class Proc {
     ...
     *                 should be a list of NULL-terminated strings. This
     *                 argument
     *                 is ignored for APR_PROGRAM_ENV, APR_PROGRAM_PATH, and
     *                 APR_SHELLCMD_ENV types of commands.
     * @param attr     The procattr we should use to determine how to create the
     *                 new
     *                 process
     ...
     *                process
     * @param exit    exit[0] The returned exit status of the child, if a child
     *                process
     *                dies, or the signal that caused the child to die.
     *                On platforms that don't support obtaining this
     *                information,
