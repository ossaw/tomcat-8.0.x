...
public class File {
     ...
     *         modified,
     *         template must not be a string constant, but should be declared as
     *         a character
     *         array.
     *
     */
     ...
     *                 In place of the usual or'd combination of file
     *                 permissions, the
     *                 value APR_FILE_SOURCE_PERMS may be given, in which case
     *                 the source
     ...
     * @param toPath   The full path to the destination file (use / on all
     *                 systems)
     * @param perms    Access permissions for the destination file if it is
     *                 created.
     *                 In place of the usual or'd combination of file
     *                 permissions, the
     *                 value APR_FILE_SOURCE_PERMS may be given, in which case
     ...
     * @return the number of bytes read.
     */
    public static native int readFullb(long thefile, ByteBuffer buf, int offset,
            int nbytes);
     ...
     *                newFile must point to a valid apr_file_t, or point to
     *                NULL.
     ...
     *                newFile MUST point at a valid apr_file_t. It cannot be
     *                NULL.
     * @param oldFile The file to duplicate.
     * @param pool    The pool to use for the new file.
     * @return Status code.
