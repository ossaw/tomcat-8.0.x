 ...
 * - some of the gratuitous flexibility removed - instead this is more
 * predictive and
 * strict with the use cases.
 * - all Method and metadata is stored in ManagedBean. BaseModelBMean and
 * ManagedBean act
 * like Object and Class.
 * - setModelMBean is no longer called on resources ( not used in tomcat )
 * - no caching of Methods for now - operations and setters are not called
 * repeatedly in most
 * management use cases. Getters should't be called very frequently either - and
 * even if they
 * are, the overhead of getting the method should be small compared with other
 * JMX costs ( RMI, etc ).
...
public class BaseModelMBean implements DynamicMBean, MBeanRegistration,
    ...
    public Object getAttribute(String name) throws AttributeNotFoundException,
        ...
        try {
            ...
            if (t instanceof RuntimeException)
                ...
                throw new MBeanException(e, "Exception invoking method "
                        + name);
        } catch (Exception e) {
     ...
     *
     * <p>
     * <strong>IMPLEMENTATION NOTE</strong> - This implementation will
     ...
     *                                       resource type is <code>null</code>
     *                                       or invalid
     */
     ...
     *                                       when the specified notification is
     *                                       <code>null</code> or invalid
     */
    @Override
    ...
    public MBeanNotificationInfo[] getNotificationInfo() {
        ...
        MBeanNotificationInfo response[] = new MBeanNotificationInfo[current.length
                + 2];
        ...
        response[0] = new MBeanNotificationInfo(new String[] {
        ...
        response[1] = new MBeanNotificationInfo(new String[] {
