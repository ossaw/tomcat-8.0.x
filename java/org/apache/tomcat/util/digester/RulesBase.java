 ...
 * base class for specialized <code>Rules</code> implementations.
 * </p>
 *
 * <p>
...
public class RulesBase implements Rules {
     ...
     *                     subsequently added rules, or <code>null</code> for
     *                     matching
     ...
     *                     or <code>null</code> to match regardless of namespace
     *                     URI
    ...
    public List<Rule> match(String namespaceURI, String pattern) {
        ...
        if ((rulesList == null) || (rulesList.size() < 1)) {
            ...
            while (keys.hasNext()) {
                ...
                if (key.startsWith("*/")) {
                    if (pattern.equals(key.substring(2)) || pattern.endsWith(key
                            .substring(1))) {
    ...
    protected List<Rule> lookup(String namespaceURI, String pattern) {
        ...
        while (items.hasNext()) {
            Rule item = items.next();
            if ((namespaceURI.equals(item.getNamespaceURI())) || (item
