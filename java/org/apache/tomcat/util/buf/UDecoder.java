...
public final class UDecoder {
    ...
    public static final boolean ALLOW_ENCODED_SLASH = Boolean.parseBoolean(
            System.getProperty(
    ...
    public final String convert(String str, boolean query) {
        ...
        while (strPos < strLen) {
            ...
            if (metaChar == '+') {
                ...
                // it
                //                try {
                char res = (char) Integer.parseInt(str.substring(strPos + 1,
                        strPos + 3), 16);
                if (noSlash && (res == '/')) {
     ...
     *
     * @param str     The url-encoded string
     * @param enc     The encoding to use; if null, the default encoding is
     *                used. If
     *                an unsupported encoding is specified null will be returned
    ...
    private static byte convertHexDigit(byte b) {
        ...
        if ((b >= 'A') && (b <= 'F'))
            return (byte) (b - 'A' + 10);
        throw new IllegalArgumentException(sm.getString(
                "uDecoder.convertHexDigit.notHex", Character.valueOf(
                        (char) b)));
    }
