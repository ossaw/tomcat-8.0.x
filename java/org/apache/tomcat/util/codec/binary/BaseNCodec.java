...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    static class Context {
         ...
         * line. Only used when encoding. We use
         ...
         * and every 4/8 reads when decoding. This
        ...
        public String toString() {
            return String.format("%s[buffer=%s, currentLinePos=%s, eof=%s, "
                    ...
                    + "readPos=%s]", this.getClass().getSimpleName(), HexUtils
                            .toHexString(buffer), currentLinePos, eof,
     ...
     * all other characters, including any
     * equal signs.
     * </p>
     *
