 ...
 * See <a href="http://docs.oracle.com/javase/specs/">JVM specification</a> for
 * details.
...
public class JavaClass {
    ...
    JavaClass(final String class_name, final String superclass_name,
            final int access_flags, final ConstantPool constant_pool,
            final String[] interface_names,
