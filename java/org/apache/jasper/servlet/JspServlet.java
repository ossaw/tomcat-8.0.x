...
public class JspServlet extends HttpServlet implements PeriodicEventListener {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        String engineOptionsName = config.getInitParameter(
                "engineOptionsClass");
        ...
        if (engineOptionsName != null) {
            ...
            try {
                ...
                Class<?> engineOptionsClass = loader.loadClass(
                        engineOptionsName);
                Class<?>[] ctorSig = { ServletConfig.class,
                        ServletContext.class };
                Constructor<?> ctor = engineOptionsClass.getConstructor(
                        ctorSig);
        ...
        if (log.isDebugEnabled()) {
            log.debug(Localizer.getMessage("jsp.message.scratch.dir.is", options
                    .getScratchDir().toString()));
    ...
    /**
     * <p>
     * Look for a <em>precompilation request</em> as described in
    ...
    boolean preCompile(HttpServletRequest request) throws ServletException {
        ...
        queryString = queryString.substring(start + Constants.PRECOMPILE
                .length());
