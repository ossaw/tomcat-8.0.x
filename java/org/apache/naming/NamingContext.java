...
public class NamingContext implements Context {
     ...
     *                                  a context, or does not name a context of
    ...
    public void destroySubcontext(Name name) throws NamingException {
        ...
        if (name.size() > 1) {
            ...
            if (entry.type == NamingEntry.CONTEXT) {
                ...
                throw new NotContextException(sm.getString(
                        "namingContext.contextExpected"));
            }
        }
    ...
    public String getNameInNamespace() throws NamingException {
        throw new OperationNotSupportedException(sm.getString(
    ...
    protected boolean checkWritable() throws NamingException {
        if (isWritable()) {
            ...
            if (exceptionOnFailedWrite) {
                throw new javax.naming.OperationNotSupportedException(sm
                        .getString("namingContext.readOnly"));
            }
        }
        return false;
    }
