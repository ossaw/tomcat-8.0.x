...
public class DataSourceLinkFactory extends ResourceLinkFactory {
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        if (result != null) {
            ...
            if (userAttr.getContent() != null && passAttr
                    .getContent() != null) {
    ...
    protected Object wrapDataSource(Object datasource, String username,
        ...
        try {
            ...
            Constructor<?> proxyConstructor = proxyClass.getConstructor(
    ...
    public static class DataSourceHandler implements InvocationHandler {
        ...
        public DataSourceHandler(DataSource ds, String username,
        ...
        public Object invoke(Object proxy, Method method, Object[] args)
            ...
            try {
                ...
                if (t instanceof InvocationTargetException && t
                        .getCause() != null) {
                    throw t.getCause();
                } else {
                    throw t;
