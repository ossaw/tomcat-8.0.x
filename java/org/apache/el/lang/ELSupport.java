...
public class ELSupport {
    ...
    public static final boolean equals(final ELContext ctx, final Object obj0,
        ...
        if (obj0 == obj1) {
            ...
            return coerceToBoolean(ctx, obj0, false).equals(coerceToBoolean(ctx,
                    obj1, false));
            ...
            int lexCompare = coerceToString(ctx, obj0).compareTo(coerceToString(
                    ctx, obj1));
    ...
    public static final Enum<?> coerceToEnum(final ELContext ctx,
            final Object obj, @SuppressWarnings("rawtypes") Class type) {
        ...
        if (!(obj instanceof String)) {
            throw new ELException(MessageFactory.get("error.convert", obj, obj
                    .getClass(), type));
        }
     ...
     */
    public static final Boolean coerceToBoolean(final ELContext ctx,
            final Object obj, boolean primitive) throws ELException {
    ...
    protected static final Number coerceToNumber(final Number number,
        ...
        throw new ELException(MessageFactory.get("error.convert", number, number
                .getClass(), type));
    }

    public static final Number coerceToNumber(final ELContext ctx,
            final Object obj, final Class<?> type) throws ELException {
     ...
     */
    public static final String coerceToString(final ELContext ctx,
            final Object obj) {
    ...
    public static final Object coerceToType(final ELContext ctx,
            final Object obj, final Class<?> type) throws ELException {
        ...
        if (type == null || Object.class.equals(type) || (obj != null && type
                .isAssignableFrom(obj.getClass()))) {
            return obj;
        }

        if (!COERCE_TO_ZERO) {
            if (obj == null && !type.isPrimitive() && !String.class
        ...
        if (obj instanceof Set && type == Map.class && ((Set<?>) obj)
                .isEmpty()) {
    ...
    private static Object coerceToArray(final ELContext ctx, final Object obj,
        ...
        for (int i = 0; i < size; i++) {
            Array.set(result, i, coerceToType(ctx, Array.get(obj, i),
                    componentType));
        }
    ...
    public static final boolean isDoubleOp(final Object obj0,
            final Object obj1) {
