...
public abstract class AbstractHttp11Processor<S> extends AbstractProcessor<S> {
    ...
    public void setNoCompressionUserAgents(String noCompressionUserAgents) {
        if (noCompressionUserAgents == null || noCompressionUserAgents
            ...
            this.noCompressionUserAgents = Pattern.compile(
    ...
    public void setRestrictedUserAgents(String restrictedUserAgents) {
        if (restrictedUserAgents == null || restrictedUserAgents
                .length() == 0) {
    ...
    private boolean isCompressable() {
        ...
        if ((contentEncodingMB != null) && (contentEncodingMB.indexOf(
                "gzip") != -1)) {
            return false;
        }
        ...
        if ((contentLength == -1) || (contentLength > compressionMinSize)) {
            ...
            if (compressableMimeTypes != null) {
                return (startsWithStringArray(compressableMimeTypes, response
                        .getContentType()));
            }
        }
    ...
    private boolean useCompression() {
        ...
        if ((acceptEncodingMB == null) || (acceptEncodingMB.indexOf(
                "gzip") == -1)) {
            return false;
        }
    ...
    protected void initializeFilters(int maxTrailerSize,
            Set<String> allowedTrailerHeaders, int maxExtensionSize,
            int maxSwallowSize) {
        ...
        getInputBuffer().addFilter(new ChunkedInputFilter(maxTrailerSize,
                allowedTrailerHeaders, maxExtensionSize, maxSwallowSize));
    ...
    private void addInputFilter(InputFilter[] inputFilters,
        ...
        if (encodingName.equals("identity")) {
            ...
            for (int i = pluggableFilterIndex; i < inputFilters.length; i++) {
                if (inputFilters[i].getEncodingName().toString().equals(
                        encodingName)) {
    ...
    public final void action(ActionCode actionCode, Object param) {
        ...
        switch (actionCode) {
            ...
            case AVAILABLE: {
                request.setAvailable(inputBuffer.available(Boolean.TRUE.equals(
                        param)));
                break;
            }
        ...
        while (!getErrorState().isError() && keepAlive && !comet && !isAsync()
            ...
            try {
                ...
                if (endpoint.isPaused()) {
                    ...
                    request.getMimeHeaders().setLimit(endpoint
                            .getMaxHeaderCount());
                ...
                if (getLog().isDebugEnabled()) {
                    getLog().debug(sm.getString("http11processor.header.parse"),
                            e);
                }
                setErrorState(ErrorState.CLOSE_NOW, e);
                break;
            ...
            if (maxKeepAliveRequests == 1) {
                keepAlive = false;
            } else if (maxKeepAliveRequests > 0 && socketWrapper
                    .decrementKeepAlive() <= 0) {
                keepAlive = false;
            }
    ...
    private void checkExpectationAndResponseStatus() {
        if (expectation && (response.getStatus() < 200 || response
                .getStatus() > 299)) {
    ...
    protected void prepareRequest() {
        ...
        if (restrictedUserAgents != null && (http11 || keepAlive)) {
            ...
            if (userAgentValueMB != null) {
                String userAgentValue = userAgentValueMB.toString();
                if (restrictedUserAgents != null && restrictedUserAgents
                        .matcher(userAgentValue).matches()) {
                    http11 = false;
                    keepAlive = false;
                }
            }
    ...
    private void prepareResponse() {
        ...
        if (isCompressable) {
            ...
            if (vary == null) {
                ...
                headers.setValue("Vary").setString(vary.getString()
                        + ",Accept-Encoding");
            }
        }
        ...
        if (headers.getValue("Date") == null) {
            headers.setValue("Date").setString(FastHttpDateFormat
                    .getCurrentDate());
        }
        ...
        for (int i = 0; i < size; i++) {
            getOutputBuffer().sendHeader(headers.getName(i), headers.getValue(
                    i));
        }
