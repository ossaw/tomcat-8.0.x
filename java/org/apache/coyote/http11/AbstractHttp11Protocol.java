...
public abstract class AbstractHttp11Protocol<S> extends AbstractProtocol<S> {
    ...
    public void setUpgradeAsyncWriteBufferSize(
            int upgradeAsyncWriteBufferSize) {
     ...
     */
    private Set<String> allowedTrailerHeaders = Collections.newSetFromMap(
    ...
    public void addAllowedTrailerHeader(String header) {
        if (header != null) {
            allowedTrailerHeaders.add(header.trim().toLowerCase(
                    Locale.ENGLISH));
        }
    }
    ...
    public void removeAllowedTrailerHeader(String header) {
        if (header != null) {
            allowedTrailerHeaders.remove(header.trim().toLowerCase(
                    Locale.ENGLISH));
        }
    }
