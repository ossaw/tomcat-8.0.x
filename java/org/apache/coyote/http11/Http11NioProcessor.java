...
public class Http11NioProcessor extends AbstractHttp11Processor<NioChannel> {
    ...
    protected void resetTimeouts() {
        final NioEndpoint.KeyAttachment attach = (NioEndpoint.KeyAttachment) socketWrapper
                .getSocket().getAttachment();
        if (!getErrorState().isError() && attach != null && asyncStateMachine
                .isAsyncDispatching()) {
            long soTimeout = endpoint.getSoTimeout();
    ...
    protected boolean handleIncompleteRequestLineRead() {
        ...
        if (((InternalNioInputBuffer) inputBuffer)
                .getParsingRequestLinePhase() < 2) {
    ...
    protected boolean breakKeepAliveLoop(
        ...
        if (sendfileData != null && !getErrorState().isError()) {
            ...
            switch (socketWrapper.getSocket().getPoller().processSendfile(key,
    ...
    public void actionInternal(ActionCode actionCode, Object param) {
        ...
        switch (actionCode) {
                ...
                if (socketWrapper == null) {
                    ...
                    if (socketWrapper.getRemoteAddr() == null) {
                        InetAddress inetAddr = socketWrapper.getSocket()
                                .getIOChannel().socket().getInetAddress();
                        if (inetAddr != null) {
            ...
            case REQ_LOCAL_NAME_ATTRIBUTE: {
                if (socketWrapper == null) {
                    ...
                    if (socketWrapper.getLocalName() == null) {
                        InetAddress inetAddr = socketWrapper.getSocket()
                                .getIOChannel().socket().getLocalAddress();
                        if (inetAddr != null) {
            ...
            case REQ_LOCAL_ADDR_ATTRIBUTE: {
                if (socketWrapper == null) {
                    ...
                    if (socketWrapper.getLocalAddr() == null) {
                        socketWrapper.setLocalAddr(socketWrapper.getSocket()
                                .getIOChannel().socket().getLocalAddress()
                                .getHostAddress());
                    }
            ...
            case REQ_REMOTEPORT_ATTRIBUTE: {
                if (socketWrapper == null) {
                    ...
                    if (socketWrapper.getRemotePort() == -1) {
                        socketWrapper.setRemotePort(socketWrapper.getSocket()
                                .getIOChannel().socket().getPort());
                    }
            ...
            case REQ_LOCALPORT_ATTRIBUTE: {
                if (socketWrapper == null) {
                    ...
                    if (socketWrapper.getLocalPort() == -1) {
                        socketWrapper.setLocalPort(socketWrapper.getSocket()
                                .getIOChannel().socket().getLocalPort());
                    }
            ...
            case COMET_CLOSE: {
                if (socketWrapper == null || socketWrapper.getSocket()
                        .getAttachment() == null) {
                    return;
                }
                RequestInfo rp = request.getRequestProcessor();
                if (rp.getStage() != org.apache.coyote.Constants.STAGE_SERVICE) {
                    ...
                    socketWrapper.getSocket().getPoller().add(socketWrapper
                            .getSocket());
                }
                break;
            }
