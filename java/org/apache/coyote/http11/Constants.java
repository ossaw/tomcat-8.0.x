...
public final class Constants {
     ...
     * Server string.
     */
    public static final byte[] SERVER_BYTES = ByteChunk.convertToBytes(
    ...
    public static final byte[] KEEPALIVE_BYTES = ByteChunk.convertToBytes(
            KEEPALIVE);
    public static final String CHUNKED = "chunked";
    public static final byte[] ACK_BYTES = ByteChunk.convertToBytes(
    ...
    public static final byte[] HTTP_11_BYTES = ByteChunk.convertToBytes(
            HTTP_11);
