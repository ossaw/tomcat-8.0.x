...
public final class Constants {
    ...
    private static final String[] methodTransArray = { "OPTIONS", "GET", "HEAD",
    ...
    private static final String[] responseTransArray = { "Content-Type",
            ...
            "Location", "Set-Cookie", "Set-Cookie2", "Servlet-Engine", "Status",
            "WWW-Authenticate" };
    ...
    private static final Hashtable<String, Integer> responseTransHash = new Hashtable<>(
            20);
    ...
    static {
        try {
            ...
            for (i = 0; i < SC_RESP_AJP13_MAX; i++) {
                responseTransHash.put(getResponseHeaderForCode(i), Integer
                        .valueOf(0xA001 + i));
            }
        } catch (Exception e) {
            // Do nothing
