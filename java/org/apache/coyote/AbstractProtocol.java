...
public abstract class AbstractProtocol<S> implements ProtocolHandler,
            ...
            if (mserver == null) {
                ...
                try {
                    ...
                    getLog().info(sm.getString(
                            "abstractProtocol.mbeanDeregistrationFailed", oname,
                            mserver));
                }
            }
        }
    ...
    protected abstract static class AbstractConnectionHandler<S, P extends Processor<S>>
        ...
        protected final RecycledProcessors<P, S> recycledProcessors = new RecycledProcessors<>(
                this);
            ...
            try {
                ...
                do {
                    if (status == SocketStatus.CLOSE_NOW) {
                        ...
                        if (processor.isUpgrade()) {
                            state = processor.upgradeDispatch(nextDispatch
                                    .getSocketStatus());
                        } else {
                            state = processor.asyncDispatch(nextDispatch
                                    .getSocketStatus());
                        }
                        ...
                        if (state == SocketState.OPEN) {
                            ...
                            // fire
                            getProtocol().endpoint.removeWaitingRequest(
                                    wrapper);
                    ...
                    if (state == SocketState.UPGRADING) {
                        ...
                        HttpUpgradeHandler httpUpgradeHandler = upgradeToken
                        ...
                        if (upgradeToken.getInstanceManager() == null) {
                            ...
                            ClassLoader oldCL = upgradeToken.getContextBind()
                                    .bind(false, null);
                            try {
                                httpUpgradeHandler.init(
                                        (WebConnection) processor);
                            } finally {
                    ...
                    if (getLog().isDebugEnabled()) {
                        getLog().debug("Socket: [" + wrapper + "], Status in: ["
                    ...
                    if (dispatches == null || !dispatches.hasNext()) {
                        ...
                        || state == SocketState.UPGRADING || dispatches != null
                                && state != SocketState.CLOSED);
                ...
                if (state == SocketState.LONG) {
                    ...
                    if (processor.isUpgrade()) {
                        ...
                        HttpUpgradeHandler httpUpgradeHandler = upgradeToken
                                .getHttpUpgradeHandler();
                        InstanceManager instanceManager = upgradeToken
                                .getInstanceManager();
                ...
                synchronized (this) {
                    try {
                        ...
                        ObjectName rpName = new ObjectName(getProtocol()
                                ...
                                + getProtocol().getName() + ",name="
                                + getProtocol().getProtocolName() + "Request"
                                + count);
                        if (getLog().isDebugEnabled()) {
    ...
    protected static class RecycledProcessors<P extends Processor<S>, S> extends
            SynchronizedStack<Processor<S>> {
