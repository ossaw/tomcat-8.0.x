...
public abstract class ELResolver {
     ...
     *                                   If the base/property combination
     *                                   provided to the resolver is
     *                                   one that the resolver can handle but no
     *                                   match was found or a
     ...
     *                                      If the base/property combination
     *                                      provided to the resolver is
     *                                      one that the resolver can handle but
     *                                      no match was found
