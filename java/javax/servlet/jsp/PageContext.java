 ...
 * authors.
 * <p>
 * The methods supporting <B>lifecycle</B> are <code>initialize()</code>
...
public abstract class PageContext extends JspContext {
     ...
     * @param flush           True if the JspWriter is to be flushed before the
     *                        include,
     *                        or false if not.
     *
     * @throws ServletException if the page that was forwarded to throws
     ...
     *
     * @throws ServletException     if an error occurs while invoking the error
     *                              page
     * @throws IOException          if an I/O error occurred while invoking the
     *                              error
     *                              page
