...
public class SimpleTagSupport implements SimpleTag {
     ...
     *                      (either directly or indirectly) invoked this tag is
     *                      to
     *                      cease evaluation. A Simple Tag Handler generated
     *                      from a
     *                      tag file must throw this exception if an invoked
     *                      Classic
     *                      Tag Handler returned SKIP_PAGE or if an invoked
     *                      Simple
     *                      Tag Handler threw SkipPageException or if an invoked
     *                      Jsp Fragment
    ...
    public static final JspTag findAncestorWithClass(JspTag from,
        ...
        if (from == null || klass == null || (!JspTag.class.isAssignableFrom(
                klass) && !(isInterface = klass.isInterface()))) {
            return null;
        }
        ...
        for (;;) {
            ...
            if ((isInterface && klass.isInstance(parent)) || klass
