...
public class ShowSource extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        if ((jspFile.indexOf("..") >= 0) || (jspFile.toUpperCase(Locale.ENGLISH)
                .indexOf("/WEB-INF/") != 0) || (jspFile.toUpperCase(
                        Locale.ENGLISH).indexOf("/META-INF/") != 0))
            throw new JspTagException("Invalid JSP file " + jspFile);

        try (InputStream in = pageContext.getServletContext()
                .getResourceAsStream(jspFile)) {
